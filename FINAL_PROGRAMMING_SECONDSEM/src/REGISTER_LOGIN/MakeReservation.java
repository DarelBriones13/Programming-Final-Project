                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(checkoutDate, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
    ...
    private void btnMakeReservation1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMakeReservation1ActionPerformed
        ...
        errorOccurred = true;
            ...
            if (checkOutDate.before(checkInDate)) {
                JOptionPane.showMessageDialog(this, "Check-out date cannot be before Check-in date.", "Invalid Dates", JOptionPane.WARNING_MESSAGE);
                errorOccurred = true;
            } else {
        ...
        if (!errorOccurred) {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                try {
                    String filePath = "C:\\Users\\Darel Briones\\OneDrive\\Documents\\NetBeansProjects\\FINAL_PROGRAMMING_SECONDSEM\\dist\\RESERVATION LIST INFORMATION\\" + "ReservationList.txt";
