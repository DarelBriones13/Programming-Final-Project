...
public class HotelReservation extends javax.swing.JFrame {
    ...
    private void displayReservations() {
        ...
        String filePathString = "C:\\Users\\Darel Briones\\OneDrive\\Documents\\NetBeansProjects\\FINAL_PROGRAMMING_SECONDSEM\\dist\\RESERVATION LIST INFORMATION\\ReservationList.txt"; // Change the file path
...
private void updateReservationFile(DefaultTableModel model) {
    try {
        String filePathString = "C:\\Users\\Darel Briones\\OneDrive\\Documents\\NetBeansProjects\\FINAL_PROGRAMMING_SECONDSEM\\dist\\RESERVATION LIST INFORMATION\\ReservationList.txt"; 
        Path filePath = Paths.get(filePathString);
